...
// -> Both robby and cranky should respond to 'parts' 
...
// -> Add 'core' to robby.parts, cranky.parts should 
//still be empty
robby.parts.push('core');
cranky.capabilities.push('fly');
// -> Add 'fly' to robby.capabilities, after
// doing that cranky.capabilities must 
//    also have 'fly' without adding to it 
//directly, so this property has to be 
//    shared
